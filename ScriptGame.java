...
public ScriptGame(){
  ...
  do{
  System.out.print("Silakan masukkan angka 1 untuk memilih karakter x "
    + "atau angka 2 untuk memilih karakter o "
  ...
  if(pilihKarakter == 1){
   ...
   System.out.println("Papan telah diinisilisasin"
     + "**************************");
    }else{System.out.println("Pilihan anda tidak valid!n"
      + "*************************");
     }
...
//Method untuk inisialisasi
  ...
  private boolean cekPilihKarakter (char giliranPemain){
   ...
   pilihKarakter = giliranPemain == 'x' || giliranPemain =='o';
